...
public class UIConfig {
	...
	public static Menu MENU_CATEGORIES = new Menu(R.string.kategori, R.drawable.ic_categories, R.drawable.ic_categories, HeaderType.HeaderType_CATEGORY);
	...
	public static Menu MENU_FEATURED = new Menu(R.string.tampilkan, R.drawable.ic_featured, R.drawable.ic_featured, HeaderType.HeaderType_CATEGORY);
	...
	public static Menu MENU_NEWS = new Menu(R.string.berita, R.drawable.ic_news, R.drawable.ic_news, HeaderType.HeaderType_CATEGORY);
	public static Menu MENU_WEATHER = new Menu(R.string.cuaca, R.drawable.ic_weather, R.drawable.ic_weather, HeaderType.HeaderType_CATEGORY);
	...
	public static Menu MENU_TERMS_CONDITION = new Menu(R.string.panduan2, R.drawable.ic_tc, R.drawable.ic_tc, HeaderType.HeaderType_CATEGORY);
	...
	public static Menu MENU_REGISTER = new Menu(R.string.daftar, R.drawable.ic_register, R.drawable.ic_register, HeaderType.HeaderType_CATEGORY);
	...
	public static Menu HEADER_CATEGORIES = new Menu(R.string.header_kategori, -1, -1, HeaderType.HeaderType_LABEL);
